...
#         "gender": random.choices(['male', 'female'],  k=size),
#         "age": random.choices(list(range(20, 28)), k=size)
        
#     })

#     data_pilot, data_control = select_stratified_groups(data,
#         strat_columns=strat_columns, group_size = 15,
