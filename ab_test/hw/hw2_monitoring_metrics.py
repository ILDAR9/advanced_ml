...
if __name__ == "__main__":
    df = pd.DataFrame(
        [[820, '2021-04-03', 1, 213], [730, '2021-04-03', 2, 213],  [730, '2021-04-03', 1, 243]],
        columns=['cost', 'date', 'sale_id', 'shop_id']
    )
    dfmetrics = calculate_sales_metrics(df,
                                        cost_name='cost', date_name='date', sale_id_name='sale_id',
                                        period={'begin': '2021-04-01', 'end': '2021-04-10'})
    print(dfmetrics)
